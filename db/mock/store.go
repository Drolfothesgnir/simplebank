...
import (
	...
	sqlc "github.com/Drolfothesgnir/simplebank/db/sqlc"
...
func (m *MockStore) TransferTx(ctx context.Context, arg sqlc.CreateTransferParams) (sqlc.TransferTxResult, error) {
	m.ctrl.T.Helper()
